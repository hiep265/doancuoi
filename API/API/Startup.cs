...
namespace API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            // Sử dụng thư mục wkhtmltopdf đã tạo
            services.AddWkhtmltopdf("wkhtmltopdf\\bin");
        ...
        public async void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseStaticFiles();
            // Thêm cấu hình để cho phép liệt kê thư mục
            ...
            //seed db
            // await SeedData.Seed(app); // Comment lại việc seed dữ liệu tự động
        }
    }
}
