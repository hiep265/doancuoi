...
import { ConfirmDialogComponent } from './admin/containers/shared/confirm-dialog/confirm-dialog.component';
...
import { BlogsComponent, BlogContentDetailComponent } from './admin/containers/views/blogs/blogs.component';
